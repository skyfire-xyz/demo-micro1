...
export default function InterviewReportsCarousel() {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-6">Example Interview Reports</h1>
              ...
              <Card className="mb-6">
                <CardHeader>
                  <div className="flex justify-between items-start">
                    <div>
                      <CardTitle>{report.interview_name}</CardTitle>
                      <CardDescription>
                        {report.candidate_name} - {report.candidate_email_id}
                      </CardDescription>
                    </div>
                    <Badge
                      variant={
                        report.proctoring_score > 50
                          ? "destructive"
                          : "secondary"
                      }
                    >
                ...
                <CardContent>
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="technical-skills">
                      ...
                      <AccordionContent>
                        <ScrollArea className="h-[200px] w-full rounded-md border p-4">
                          {report.technical_skills_evaluation.map(
                            (skill, skillIndex) => (
                    ...
                    <AccordionItem value="soft-skills">
                      ...
                      <AccordionContent>
                        <ScrollArea className="h-[200px] w-full rounded-md border p-4">
                          {report.soft_skills_evaluation.map(
                            (skill, skillIndex) => (
                              <div key={skillIndex} className="mb-4">
                                <h4 className="font-semibold">{skill.skill}</h4>
                                <p className="text-sm">
